...
public class Camera2Fragment extends Fragment implements
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.switch_orientation) {
            Log.d(TAG, "onClick: switching camera orientation.");
            toggleCameraDisplayOrientation();
        } else if (id == R.id.close_stillshot_view) {
            hideStillshotContainer();
        } else if (id == R.id.init_draw_icon) {
            toggleColorPickerVisibility();
        } else if (id == R.id.undo_container) {
            undoAction();
        } else if (id == R.id.save_stillshot) {
            saveCapturedStillshotToDisk();
        } else if (id == R.id.init_sticker_icon) {
            toggleStickers();
        } else if (id == R.id.flash_toggle) {
            if (!mIsImageAvailable) {
                toggleFlashState();
            }
        }
